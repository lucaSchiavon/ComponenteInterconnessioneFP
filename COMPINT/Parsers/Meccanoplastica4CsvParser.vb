...
Module Meccanoplastica4CsvParser
    Public Function ParseProduzioneCsv(percorsoFile As String, settings As Settings) As Meccanoplastica4CsvDto
        ...
        'Popolamento DTO
        Dim dto As New Meccanoplastica4CsvDto()
