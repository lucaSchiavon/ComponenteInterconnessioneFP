...
Public Module ICAVL08616CsvParser
    Public Function ParseProduzioneCsv(percorsoFile As String, settings As Settings, secondExecution As Boolean) As ICAVL08616CsvDto
        ...
        'Popolamento DTO
        Dim dto As New ICAVL08616CsvDto()
