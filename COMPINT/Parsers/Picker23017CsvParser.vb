...
Module Picker23017CsvParser
    Public Function ParseProduzioneCsv(percorsoFile As String, settings As Settings, secondExecution As Boolean) As Picker23017CsvDto
        ...
        End If
        'Popolamento DTO
        Dim dto As New Picker23017CsvDto()
        Dim culture As CultureInfo = CultureInfo.InvariantCulture

        dto.DataEOra = DateTime.Parse(General.ConvertiDataCustom(dati(0), GlobalConstants.MACHINENAME_PICKER23017), New CultureInfo("it-IT"))
